...
import com.vasukotadiya.bbadmin.Adapters.PassengerScreenBusAdapter;
...
public class PassengerScreen1 extends AppCompatActivity {
    ...
    private void Initialize() {
        ...
        Date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(PassengerScreen1.this, date1, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH));
